...
<div class="inner_banner_agileinfo" id="home">
 ...
 <div class="row" style="text-align:center;">
		...
		<p> <h3 class="title-w3-agileits">Sign-up new user</h3><br><br>

	<P><b>EXISTING USER CLICK <a href="USERLOGIN.php" <span data-letters="Home">HERE</span></a> TO LOGIN</b></p>		

		
         <form action="contactmgt.php" method="POST"><br><br>
...
{
echo"<script>alert('PLS enter your firstname')</script>";
exit();	
}
...
$ff="insert into regtbl(firstname,lastname,email,username,password)values('$fname','$lname','$mail','$uname','$pwd')";
